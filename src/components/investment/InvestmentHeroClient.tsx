...
interface ProcessedInvestmentHeroData {
  title: string;
  description: string;
  heroImages: {
...
interface InvestmentHeroClientProps {
  data?: ProcessedInvestmentHeroData;
}

const InvestmentHeroClient: React.FC<InvestmentHeroClientProps> = ({ data }) => {
  // Fallback data
  const fallbackData = {
    title: "INVESTMENT",
    description:
        ...
        <div className="relative z-20 px-[5vw] lg:px-[3.5vw] h-full flex items-start">
          ...
          <div className="hidden lg:block absolute bottom-1/4 left-1/4 z-10">
            ...
            >
              ...
              <br />
              {content.quoteOverlay?.author || "Emily & Ryan"}
            </p>
          </div>
              ...
              <div className="block md:hidden w-full h-full relative">
                <div className="border border-black h-full shadow-lg">
                  <div className="w-full h-full relative overflow-hidden">
                    <ImageWithFallback
                      src={content.heroImages?.mainImageUrl}
                ...
                <div className="w-2/5 flex flex-col items-start gap-3 md:gap-4 lg:gap-6">
                  ...
                  <div className="h-[60%] w-full md:w-[85%] lg:w-[85%] relative">
                    <div className="border border-black h-full shadow-lg">
                      <div className="w-full h-full relative overflow-hidden">
                        <ImageWithFallback
                          src={content.heroImages?.topSmallImageUrl}
                  ...
                  <div className="h-[40%] w-full relative">
                    ...
                    {/* Reel overlay - only show if there's an actual image */}
                    {content.heroImages?.bottomSmallImageUrl && (
...
export default InvestmentHeroClient;