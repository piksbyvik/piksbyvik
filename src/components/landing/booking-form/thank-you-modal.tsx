...
import { motion, AnimatePresence, easeIn, spring, cubicBezier, easeOut, easeInOut } from "motion/react";
...
const ThankYouModal: React.FC<ThankYouModalProps> = ({ customerName, onClose }) => {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <motion.div 
          className="relative w-full max-w-4xl bg-gradient-to-br from-[#403528] to-[#2a261e] shadow-2xl overflow-hidden my-4 sm:my-8"
          style={{
            borderRadius: '16px',
        ...
        >
          ...
          >
            ...
            >
              <div className="relative h-40 sm:h-64 lg:h-full lg:min-h-[500px] overflow-hidden">
                <motion.div
            ...
            {/* Right side - Content */}
            <motion.div 
              className="w-full lg:w-3/5 text-white p-4 sm:p-6 lg:p-12 flex flex-col justify-center order-1 lg:order-2 overflow-y-auto"
              variants={contentVariants}
            >
              {/* Header */}
              <motion.div variants={itemVariants}>
                <h2 className="font-la-belle-aurore text-2xl sm:text-3xl lg:text-4xl mb-6 lg:mb-8 leading-relaxed">
                  <motion.span 
                    className="block"
              ...
              >
                ...
                >
                  <span className="font-inconsolata text-white/80 tracking-wider text-sm sm:text-base">TO :</span>
                  <motion.span 
                ...
                >
                  <span className="font-inconsolata text-white/80 tracking-wider text-sm sm:text-base">DATE :</span>
                  <motion.span 
